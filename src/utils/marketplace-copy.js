...
export const STORE = {
  ...
  openNowEyebrow: 'Comercios cerca',
  openNowTitle: (municipio) => `Abiertos ahora en ${municipio}`,
  openNowSubtitle: 'Restaurantes, mercados y tiendas con entrega a domicilio',
  openNowSubtitleClosed: 'Hay tiendas en tu zona, pero ninguna abierta en este momento',
  openNowSubtitleFallback: 'Explora comercios con entrega y seguimiento en vivo',
  openNowCount: (n) => `${n} tienda${n === 1 ? '' : 's'} abierta${n === 1 ? '' : 's'}`,
