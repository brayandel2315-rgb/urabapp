...
const ROUTE_META = [
  ...
  { path: '/login', title: 'Entrar', description: 'Elige tu perfil: cliente, comercio o domiciliario.' },
  { path: '/registro', title: 'Crear cuenta', description: 'Regístrate como cliente, comercio o domiciliario en Urabapp.' },
